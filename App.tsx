...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col overflow-x-hidden bg-[#05070a]">
      ...
      <footer className="w-full pb-32 pt-12 px-6 shrink-0 bg-[#05070a]">
        <div className="max-w-md mx-auto flex flex-col items-center text-center">
          <div className="w-12 h-[1px] bg-gradient-to-r from-transparent via-slate-700 to-transparent mb-8"></div>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-1">
              <p className="text-[10px] text-slate-400 font-medium uppercase tracking-[0.3em] opacity-70">
